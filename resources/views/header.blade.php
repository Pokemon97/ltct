		...
		<div class="container">
			...
			<div class="pull-right auto-width-right">
				...
				@if(Auth::check())
					...
					<li><a href="{{route('personal_information')}}"><b style="color: blue; font-size: 115%">Xem thông tin</b></a></li>
					<li><a href="{{route('change_password')}}"><b style="color: blue; font-size: 115%">Đổi mật khẩu</b></a></li>
				...
				<div class="beta-comp">
					<div class="cart">
						...
						@if(Session::has('cart'))
							...
							@if(number_format(Session('cart')->totalQty) != 0)
							...
							@else
							<div class="cart-caption">
								<div class="cart-total text-right">Không có sản phẩm</div>
								<div class="clearfix"></div>
